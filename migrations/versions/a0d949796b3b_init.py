...
Revision ID: a0d949796b3b
Revises: 
Create Date: 2024-12-15 15:37:57.974267
...
def upgrade() -> None:
    ...
    sa.Column('skip_answer', sa.Integer(), nullable=False),
    sa.Column('memorization_time', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['result_keeper_id'], ['associative_changing_table.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
