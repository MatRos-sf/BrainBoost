...
class TestAssociativeChaining:
    ...
    def test_size_of_payload(self, level, expected):
        ...
        associative_chaining = AssociativeChaining(level)
    ...
    @patch("src.games.memonics.associative_chaining.AssociativeChaining.create_payload")
    @patch("src.games.memonics.associative_chaining.AssociativeChaining.check_answer")
